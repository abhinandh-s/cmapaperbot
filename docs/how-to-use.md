## How to Use CMA Paper Bot

### 1. Via Commands

<div class="no-print" style="text-align: center;">
    <video width="100%" controls>
        <source src="assets/cmds_tutorial.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>

Simply start a chat with [@cmapaperbot](https://t.me/cmapaperbot) and request the paper you need via commands.
...
<div class="no-print" style="text-align: center;">
    <video width="100%" controls>
        <source src="assets/inline_tutorial.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>

Users can interact with the CMA Paper Bot via inline queries straight from the message field in any chat. All we need to do is start a message with the bot's username [@cmapaperbot](https://t.me/cmapaperbot) and enter a keyword.
...
### 3. Via Direct Message

<div class="no-print" style="text-align: center;">
    <video width="100%" controls>
        <source src="assets/dm_tutorial.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
</div>
...
> [!NOTE]
> query format is same as for Inline mode.
